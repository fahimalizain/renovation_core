...
from .get_custom_field_values_for import get_custom_field_values_for_resolver
...
from .update_custom_field_values_for import update_custom_field_values_for_resolver


def bind_resolvers(schema: GraphQLSchema):
    schema.query_type.fields["CustomFieldsGet"].resolve = get_custom_fields_resolver
    schema.query_type.fields["CustomFieldGetValuesFor"].resolve = \
        get_custom_field_values_for_resolver
    ...
    schema.mutation_type.fields["CustomFieldUpdateValuesFor"].resolve = \
        update_custom_field_values_for_resolver
